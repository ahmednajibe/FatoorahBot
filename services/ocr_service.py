...
class OCRService:
    ...
    📅 **صياغة التاريخ (مهم جداً):**
    - مهما كانت صياغة التاريخ في الفاتورة، أرجعه دائماً بصيغة: DD/MM/YYYY
    - مثال: إذا كان "2024-01-15" أو "15/1/24" → أرجعه "15/01/2024"
    - تأكد أن اليوم أولاً، ثم الشهر، ثم السنة كاملة (4 أرقام)
    ...
    💰 **الأسعار والضريبة (مهم جداً):**
    
    1. **إذا كانت الأسعار شاملة الضريبة** (Price Includes VAT / السعر شامل الضريبة):
       - استخرج الـ subtotal و item.total **بدون الضريبة**
       - الـ subtotal = NET TOTAL (المجموع الصافي قبل الضريبة)
       - item.total = سعر الصنف بدون الضريبة
       - مثال: إذا كان المنتج 115 ريال شامل 15% ضريبة، الـ total = 100
    
    2. **إذا كانت الأسعار غير شاملة الضريبة**:
       - استخرج الأسعار كما هي
